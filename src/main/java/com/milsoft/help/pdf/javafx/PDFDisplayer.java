...
public class PDFDisplayer {
    ...
    public PDFDisplayer(int initialPage) {
    ...
    public PDFDisplayer(String relativeFileName) {

        this.relativeFileName = relativeFileName;
    }

    public void displayPdf(String relativeFileName) throws IOException {
        this.relativeFileName = relativeFileName;
    }
    ...
    private WebView createWebView() {
        setVisibilityOf("download", false);
        setVisibilityOf("print", false);
